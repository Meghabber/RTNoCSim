...
// les fonctions sont :
//			*  Req_Arbitration(ArrayList<Integer> List_port):
				//pour arbitré et supprimer le premier de le list
//			*  Selector(ArrayList<Integer> List_port):
					//sert a pré-selectionner un candidat de List_Port_for_Arbiter
//			*  Req_Arbitration(ArrayList<Integer> List_port,int first_data):
				//pour arbitré et supprimer qui est le id (first_data) de le list
package Router;

import java.util.ArrayList;

public class RT_Arbiter implements Arbiter{
